...
if __name__ == "__main__":
    ...
    # Send coins
    # it would be dumb of the miner to include the ones that offered No tx fee
    # before including the ones that have a Tx Fee --> HOW YOU LOSE MONEY
    sendCoins(pu1, 0.1, pr1, pu2, 0.1, miners) # 10 Txs with no Tx Fee
    ...
    sendCoins(pu1, 0.1, pr1, pu2, 0.1, miners)
    sendCoins(pu1, 0.1, pr1, pu2, 0.1, miners)
    sendCoins(pu1, 0.1, pr1, pu3, 0.03, miners) # 10 Txs with a 0.07 Tx Fee
...
##    num_heads = len(head_blocks) # count the number of head nodes
